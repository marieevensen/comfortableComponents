<template>
  	<main class="home-quiz">
		<div class="home-quiz__question">
			{{ currentQuestion.query }}
		</div>

		<div class="home-quiz__options">
			<button class="home-options__option" v-for="option in currentQuestion.options" @click="optionClicked(option)">
				{{ option }}
			</button>
			...
			<button class="home-options__start-over" @click="startOver" v-else>
...
<style>
	...
	.home-options__option:hover {
		border: black 1px solid;
	}

	.home-options__option:focus {
		background-color: black;
		color: white;
	}

	.home-options__start-over {
		margin-top: 50px;
	}

	.home-options__start-over:hover {
